...
class PropertyItem(scrapy.Item):
    ...
    address = scrapy.Field(input_processor=MapCompose(clean_address), output_processor=TakeFirst())
    property_size = scrapy.Field(input_processor=MapCompose(clean_sqft), output_processor=TakeFirst())
